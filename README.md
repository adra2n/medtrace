...
- **v3.5.0**（versionCode 24，2026-07-23）
  ...
  - UI/UX：EmptyState/LoadingError 统一组件、页面转场动画、深色模式优化。
  - 安全：LLM API Key 改用 EncryptedSharedPreferences 加密存储。
  - 测试：36 个单元测试（Repository、LLM、Converter）。
  - GitHub Releases：<https://github.com/adra2n/medtrace/releases/tag/v3.5.0>
